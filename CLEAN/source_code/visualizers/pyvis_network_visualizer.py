...
def display_graph_pyvis(adj_mat, edge_type_matrix=None, abs_val_edges=True, include_physics_buttons=True, 
                        equal_edge_weights=False, rank_edge_coloring=False, make_zero_edge_midpoint=False, size_highlight=[], border_highlight=[], shape_highlight=[], 
