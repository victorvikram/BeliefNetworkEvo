...
and agree on connections to all their neighbors
- modules: parts of the network that are tightly connected but only sparsely connected to other parts of the network
"""
